// === КОНТРАГЕНТЫ v2: БЕЗОПАСНАЯ ВЕРСИЯ ===
// Поиск по телефону/адресу для дедупликации
...
// Обновлённый getOrCreateClient с миграцией
...
// Проверка дубликата при вводе телефона/адреса
